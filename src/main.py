...
if __name__ == "__main__":
  ...
  # checkpoint = torch.load("model_weights/cctdetnew/weights_0/model_epoch_2.pth")
  ...
  for epoch in range(1, epochs + 1):
    ...
    metrics = evaluate(model, val_dl, device, num_classes_to_evaluate=len(class_names))
    print(f"Evaluation metrics after epoch {epoch}:")
